...
function DefaultView(props) {
  ...
  if (!props.mainPic) {
    ...
    return (
      ...
      // </div>
      <div className="default-view" style={{ backgroundImage: "url(" + props.mainPic + ")" }} onClick={() => props.expand()}>
        {/* <h1>Default View</h1> */}
  ...
  if (props.mainPic.length === 0) {
    ...
    return (
      ...
      // </div >
      <div className="default-view" style={{ backgroundImage: "url(" + props.mainPic + ")" }} onClick={() => props.expand()} data-testid="default-view-test">
      </div>
    )
  }
