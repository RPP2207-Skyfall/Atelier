    ...
    if (this.state.product_detail.length === 0 || this.state.currentPic.length === 0) {
      ...
      return (
        <div className="carousel-box">
            <img className = "image-box" src={this.state.image} alt="style" />
          <button className="star-btn" ></button>
          <div className="category-box">
            <div className="category-title">{this.state.details.category}</div>
            <div className="category-wrapper">
              <p>{this.state.details.name}</p>
              <div className="price-box">
                ${this.state.details.default_price}
              </div>
