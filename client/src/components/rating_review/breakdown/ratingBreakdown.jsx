  ...
  return (
    <div className="rating-breakdownn-container">
      ...
      {individualRating !== undefined ? individualRating.map((valueSet, idx) =>
        <Bar key={idx} idx={idx} totalAmount={totalAmount} star={valueSet[0]} ratingAmount={valueSet[1]} hanleFilterClicked={props.hanleFilterClicked} filterClicked={props.filterClicked} resetHighlighted={props.resetHighlighted} />
      ) : null}
    </div>
